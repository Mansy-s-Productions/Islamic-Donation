                    ...
                    <div class="container">
                        <form action="{{route('admin.hadith.postEdit', [$TheHadith['id'], $lang])}}" method="POST" enctype="multipart/form-data" >
                            @csrf
                                ...
                                <a class="mt-3 inline-block fancybox" href="{{asset(HadithImageSrc($lang, $TheHadith['id']))}}" data-fancybox="gallery{{$TheHadith['id']}}">
                                    <img width="100" src="{{asset(HadithImageSrc($lang, $TheHadith['id']))}}" alt=""></td>
                                </a>
