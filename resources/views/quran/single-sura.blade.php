            ...
            <div class="container">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="dropdown-center" >
                                ...
                                <ul class="dropdown-menu languages-menu">
                                    @foreach ($TranslationsList['translations'] as $language)
                                        <li><a class="dropdown-item" href="{{route('singleSura', [$language['language_iso_code'] ,$language['key'], $FinalQuran[0]['sura']])}}">
                                            {{$language['title']}}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                ...
                <div class="row">
                    @if (empty($ImagesFiles))
                            ...
                            @else
                            @foreach ($FinalQuran as $key => $Aya)
                                @if (in_array($Aya['aya'], $ImagesFiles))
                                    <div class="col-12">
