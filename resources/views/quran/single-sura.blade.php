                                    ...
                                    <div class="note_btns d-flex justify-content-between" dir="ltr">
                                        <div class="d-flex align-items-ceeter">
                                            ...
                                            <div class="checkbox-wrapper-31">
                                                ...
                                                <input type="radio" data-bs-toggle="modal" id="ModalSubmit{{$Aya['id']}}" data-bs-target=".modal" data-type="quran" data-sura="{{$Aya['sura']}}" data-id="{{$Aya['id']}}" data-language="{{$lang}}" data-user="{{ Auth()->user()->id }}" @if (in_array($Aya['id'] ,$arrays)) class="submit-design-btn active" checked data-checked="true" @else class="submit-design-btn" data-cheked="false" @endif/>
